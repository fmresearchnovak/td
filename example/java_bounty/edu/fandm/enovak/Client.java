...
public final class Client {
    ...
    public long getClientCount(){
        return Client.clientCount.get();
    }

    public Client(ResultHandler updateHandler, ExceptionHandler updateExceptionHandler, ExceptionHandler defaultExceptionHandler) {
