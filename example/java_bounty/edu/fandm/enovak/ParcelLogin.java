...
public class ParcelLogin {
    ...
    private static String msgToRecipient;
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        msgToRecipient = args[1];
        System.out.println("Sending \"" + msgToRecipient + "\" to " + recipientPhoneNumber);
    ...
    private static class PrivateChatHandler implements Client.ResultHandler {
        ...
        public void onResult(TdApi.Object object){
            if(object.getConstructor() == TdApi.Chat.CONSTRUCTOR){
                ...
                TdApi.InputMessageContent msg = new TdApi.InputMessageText(new TdApi.FormattedText(msgToRecipient, null), null, true);
                ...
                System.out.println("Sent message (" + msgToRecipient + ")  to " + recipientPhoneNumber);
                msgSent = true;
            } else {
